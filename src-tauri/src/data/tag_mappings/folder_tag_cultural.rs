[
    ...
    ("genre:jazz:noir", "Cultural Styles/Modern Era/Film Noir", 9, "Noir jazz music"),
    
    // === ADDITIONAL GENRE MAPPINGS ===
    ("atompunk", "Cultural Styles/Steampunk & Victorian/Dieselpunk", 10, "Atompunk cultural music"),
    ("solarpunk", "Cultural Styles/Modern Era/Contemporary", 10, "Solarpunk eco-futuristic music"),
    ("post-apocalyptic", "Sci-Fi Genres/Post-Apocalyptic/Wasteland", 10, "Post-apocalyptic atmosphere music"),
    ("modern-urban", "Cultural Styles/Modern Era/Urban Culture", 9, "Modern urban cultural music"),
    
    // === GENRE PREFIXED MAPPINGS ===
    ("genre:adventure", "Session Structure/Adventure Sequences/Exploration", 9, "Adventure music genre"),
    ("genre:children", "Fantasy Genres/Fairy Tale Fantasy/Classic Tales", 8, "Children's music genre"),
    ("genre:classical", "Musical Instruments/Orchestral/Strings", 9, "Classical music genre"),
    ("genre:classical-piano", "Cultural Styles/Modern Era/Romantic Period", 8, "Classical piano music"),
    ("genre:bluegrass", "Cultural Styles/Wild West/Frontier Towns", 8, "Bluegrass music genre"),
    ("genre:caravan", "Cultural Styles/Regional Cultures/Asian/Persian", 8, "Caravan music genre"),
    ("genre:discovery", "Session Structure/Exploration/Discovery", 8, "Discovery music genre"),
    ("genre:electronic", "Musical Instruments/Electronic/Synthesizers", 9, "Electronic music genre"),
    ("genre:exploration", "Session Structure/Exploration", 9, "Exploration music genre"),
    ("genre:fairy-tale", "Fantasy Genres/Fairy Tale Fantasy/Classic Tales", 9, "Fairy tale music genre"),
    ("genre:folk", "Musical Instruments/String Instruments/Folk Strings", 9, "Folk music genre"),
    ("genre:gospel", "Cultural Styles/Regional Cultures/African/Ethiopian", 8, "Gospel music genre"),
    ("genre:heroic", "Moods & Atmosphere/Heroic & Triumphant", 9, "Heroic music genre"),
    ("genre:hybrid", "Cultural Styles/Modern Era/Contemporary", 8, "Hybrid music genre"),
    ("genre:investigative", "Session Structure/Reveals/Mystery Reveal", 8, "Investigative music genre"),
    ("genre:mystery", "Moods & Atmosphere/Mystery & Wonder", 9, "Mystery music genre"),
    ("genre:orchestral", "Musical Instruments/Orchestral/Strings", 9, "Orchestral music genre"),
    ("genre:rebuilding", "Sci-Fi Genres/Post-Apocalyptic/Survivors/Safe Haven", 8, "Rebuilding civilization music"),
    ("genre:resistance", "Session Structure/Action Sequences/Combat", 8, "Resistance movement music"),
    ("genre:rock", "Cultural Styles/Modern Era/Contemporary", 9, "Rock music genre"),
    ("genre:scavenger", "Sci-Fi Genres/Post-Apocalyptic/Wasteland/Scavenger Camps", 8, "Scavenger music genre"),
    ("genre:survivor", "Sci-Fi Genres/Post-Apocalyptic/Survival", 8, "Survivor music genre"),
    ("genre:synthwave", "Musical Instruments/Electronic/Analog Synth", 9, "Synthwave music genre"),
    ("genre:thriller", "Moods & Atmosphere/Suspense & Uncertainty", 9, "Thriller music genre"),
    ("genre:whimsical", "Moods & Atmosphere/Playful & Light/Whimsical", 8, "Whimsical music genre"),
    ("genre:world", "Cultural Styles/Regional Cultures", 9, "World music genre"),
]