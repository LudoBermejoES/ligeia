[
    ...
    ("occasion:horror", "Session Structure/Horror Elements", 10, "General horror scenarios"),
    ("occasion:combat", "Session Structure/Action Sequences/Combat", 10, "General combat scenarios"),  
    ("occasion:combat-encounter", "Session Structure/Action Sequences/Combat", 10, "Combat encounter scenarios"),
    ("occasion:gunfight", "Session Structure/Action Sequences/Combat", 10, "Gunfight scenarios"),
    ("occasion:boss-loop", "Session Structure/Action Sequences/Boss Battle", 10, "Boss battle loop scenarios"),
    ("occasion:creature-kill", "Session Structure/Action Sequences/Combat", 9, "Monster elimination scenarios"),
    ("occasion:action-sequence", "Session Structure/Action Sequences", 10, "High-action sequences"),
    ("occasion:headshot", "Session Structure/Action Sequences/Combat", 8, "Precision kill scenarios"),
    ("occasion:chase", "Session Structure/Action Sequences/Chase", 9, "Chase sequences"),
    ...
    ("occasion:cooking", "Session Structure/Social Encounters/Inn", 9, "Cooking activity scenarios"),
    ("occasion:eating", "Session Structure/Social Encounters/Inn", 8, "Eating activity scenarios"),
    ("occasion:drinking", "Session Structure/Social Encounters/Tavern", 7, "Drinking activity scenarios"),
    ("occasion:combat-mecha", "Session Structure/Action Sequences/Combat", 9, "Mecha combat scenarios"),
    ("occasion:vehicle-chase", "Session Structure/Action Sequences/Chase", 10, "Vehicle chase scenarios"),
    ("occasion:car-chase", "Session Structure/Action Sequences/Chase", 10, "Car chase scenarios"),
    ("occasion:air-combat", "Session Structure/Action Sequences/Combat", 9, "Aerial combat scenarios"),
    ("occasion:space-battle", "Session Structure/Action Sequences/Combat", 9, "Space battle scenarios"),
    ("occasion:mech-combat", "Session Structure/Action Sequences/Combat", 9, "Mechanical combat scenarios"),
    ("occasion:sci-fi-combat", "Session Structure/Action Sequences/Combat", 9, "Science fiction combat scenarios"),
    ("occasion:tactical-combat", "Session Structure/Action Sequences/Combat", 8, "Tactical combat scenarios"),
    ("occasion:raid", "Session Structure/Action Sequences/Combat", 9, "Raid scenarios"),
    ("occasion:siege", "Session Structure/Action Sequences/Siege", 9, "Siege scenarios"),
    ("occasion:rescue-operation", "Session Structure/Action Sequences/Emergency", 8, "Rescue operation scenarios"),
    ("occasion:evacuation", "Session Structure/Action Sequences/Emergency", 8, "Evacuation scenarios"),
    ("occasion:sabotage", "Session Structure/Action Sequences/Infiltration", 8, "Sabotage scenarios"),
    ("occasion:espionage", "Session Structure/Action Sequences/Infiltration", 8, "Espionage scenarios"),
    ("occasion:reconnaissance", "Session Structure/Action Sequences/Stealth", 8, "Reconnaissance scenarios"),
    ("occasion:extraction", "Session Structure/Action Sequences/Escape", 8, "Extraction scenarios"),
    ("occasion:final-battle", "Session Structure/Action Sequences/Boss Battle", 10, "Final battle scenarios"),
    ("occasion:boss-intro", "Session Structure/Action Sequences/Boss Battle", 9, "Boss introduction scenarios"),
    ("occasion:boss-final-phase", "Session Structure/Action Sequences/Boss Battle", 9, "Boss final phase scenarios"),
    ("occasion:legendary-battle", "Session Structure/Action Sequences/Boss Battle", 9, "Legendary battle scenarios"),
    ("occasion:last-stand", "Session Structure/Action Sequences/Combat", 9, "Last stand scenarios"),
    ("occasion:dungeon-crawl", "Session Structure/Adventure Sequences/Dungeon Exploration", 10, "Dungeon crawling scenarios"),
    ("occasion:cave-exploration", "Session Structure/Exploration/Discovery", 9, "Cave exploration scenarios"),
    ("occasion:ancient-ruins", "Session Structure/Adventure Sequences/Dungeon Exploration", 8, "Ancient ruins exploration"),
    ("occasion:treasure-hunt", "Session Structure/Exploration/Discovery", 8, "Treasure hunting scenarios"),
    ("occasion:clue-discovery", "Session Structure/Reveals/Mystery Reveal", 8, "Clue discovery scenarios"),
    ("occasion:investigation", "Session Structure/Main Content/Problem Solving/Investigation", 9, "Investigation scenarios"),
    ("occasion:interrogation", "Session Structure/Social Encounters/Investigation", 8, "Interrogation scenarios"),
    ("occasion:council-meeting", "Session Structure/Social Encounters/Court", 8, "Council meeting scenarios"),
    ("occasion:guild-meeting", "Session Structure/Social Encounters/General", 8, "Guild meeting scenarios"),
    ("occasion:ceremony", "Session Structure/Social Encounters/Ceremony", 8, "Ceremony scenarios"),
    ("occasion:festival", "Session Structure/Social Encounters/Celebration", 8, "Festival scenarios"),
    ...
    ("occasion:crafting", "Session Structure/Downtime/Construction", 8, "Crafting scenarios"),
    ("occasion:magical-research", "Session Structure/Downtime/Preparation", 8, "Magical research scenarios"),
    ("occasion:healing", "Session Structure/Downtime/Healing", 8, "Healing scenarios"),
    ("occasion:meditation", "Session Structure/Downtime/Rest", 7, "Meditation scenarios"),
    ("occasion:training", "Session Structure/Downtime/Training", 8, "Training scenarios"),
    ("occasion:dark-ritual", "Session Structure/Challenges/Ritual", 9, "Dark ritual scenarios"),
    ("occasion:haunting", "Session Structure/Horror Elements", 8, "Haunting scenarios"),
    ("occasion:dream-sequence", "Session Structure/Story Elements/Flashback", 8, "Dream sequence scenarios"),
    ("occasion:flashback", "Session Structure/Story Elements/Flashback", 8, "Flashback scenarios"),
    ("occasion:identity-reveal", "Session Structure/Reveals/Mystery Reveal", 8, "Identity reveal scenarios"),
    ("occasion:betrayal-reveal", "Session Structure/Reveals/Mystery Reveal", 8, "Betrayal reveal scenarios"),
    ("occasion:cosmic-revelation", "Session Structure/Reveals/Mystery Reveal", 8, "Cosmic revelation scenarios"),
    ("occasion:cliffhanger", "Session Structure/Endings & Conclusions/Session End/Cliffhanger", 8, "Cliffhanger scenarios"),
    ("occasion:bittersweet-ending", "Session Structure/Endings & Conclusions/Session End/Bittersweet Ending", 7, "Bittersweet ending scenarios"),
    
    // === FINAL UNMAPPED OCCASION TAGS FROM ANALYSIS ===
    ("action-sequence", "Session Structure/Action Sequences", 9, "General action sequences"),
    ("combat-encounter", "Session Structure/Action Sequences/Combat", 10, "Combat encounter scenarios"),
    ("creature-kill", "Session Structure/Action Sequences/Combat", 9, "Monster elimination scenarios"),
    ("gunfight", "Session Structure/Action Sequences/Combat", 10, "Gunfight scenarios"),
    ("headshot", "Session Structure/Action Sequences/Combat", 8, "Precision kill scenarios"),
    ("injury", "Session Structure/Action Sequences/Combat", 7, "Injury scenarios"),
]